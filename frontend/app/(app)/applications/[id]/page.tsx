              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <StatusBadge tone={decisionBadge.tone}>
                      {decisionBadge.label}
                    </StatusBadge>
                  </div>
              ...
              <div className="rounded-[28px] border border-white/10 bg-white/6 p-5">
                ...
                <p className="mt-3 text-sm leading-7 text-white/78">
                  {decisionOutput?.reasoning ||
                    "No decision reasoning is available yet for this application."}
                </p>
              </div>
                  ...
                  <div className="rounded-[28px] border border-slate-200/80 bg-slate-950 p-6 text-white">
                    <div className="space-y-5">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <StatusBadge tone={plannerStatus.tone}>
                          {plannerStatus.label}
                        </StatusBadge>
                        <StatusBadge tone="cyan">
                          {completedRuns} completed workers
                        </StatusBadge>
                      </div>
            ...
            <CardContent className="grid gap-4 py-6 sm:grid-cols-2">
              {applicationDetailItems.map(({ label, value, Icon }) => (
                ...
                >
                  ...
                  <p className="mt-3 text-base leading-7 font-medium text-slate-950">
                    {value}
                  </p>
                </div>
              ))}
                      ...
                      >
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                          <div className="flex gap-4">
                            <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-white text-indigo-600 shadow-sm">
                          ...
                          <StatusBadge tone="cyan">
                            {humanize(document.upload_status)}
                          </StatusBadge>
                        </div>
          ...
          <Card className="page-surface py-0">
            ...
            <CardContent className="space-y-4 py-6">
              <div className="flex gap-4 rounded-[24px] border border-slate-200/80 bg-slate-50/80 p-4">
                <div className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-white text-slate-700 shadow-sm">
